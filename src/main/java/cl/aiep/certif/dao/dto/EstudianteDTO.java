...
public class EstudianteDTO implements Serializable {
	...
	@NotEmpty(message = "RUN es requerido.")
	private String rut;
	...
	@Min(value = 1, message = "Región es requerido.")
	...
	public EstudianteDTO(String rut, String nombre, String telefono, String direccion, String email, Integer idRegion,
			String password, Integer enabled, Integer idCurso, Integer edad) {
		super();
		this.rut = rut;
		this.nombre = nombre;
		this.telefono = telefono;
